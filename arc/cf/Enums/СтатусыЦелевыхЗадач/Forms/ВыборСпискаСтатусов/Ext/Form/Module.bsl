...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого Значение Из Метаданные.Перечисления.СтатусыЦелевыхЗадач.ЗначенияПеречисления Цикл
		
		ЗначениеСсылка = Перечисления.СтатусыЦелевыхЗадач[Значение.Имя];
