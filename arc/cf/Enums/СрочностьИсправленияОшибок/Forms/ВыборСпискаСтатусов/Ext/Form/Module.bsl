...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого Значение Из Метаданные.Перечисления.СрочностьИсправленияОшибок.ЗначенияПеречисления Цикл
		
		ЗначениеСсылка = Перечисления.СрочностьИсправленияОшибок[Значение.Имя];
