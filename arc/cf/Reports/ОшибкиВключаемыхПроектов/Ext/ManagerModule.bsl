...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ОшибкиПроектовБиблиотек");
	НастройкиВарианта.Описание = 
		НСтр("ru = 'Содержит информацию о наличии ошибок библиотек в составе конфигурации.'");
