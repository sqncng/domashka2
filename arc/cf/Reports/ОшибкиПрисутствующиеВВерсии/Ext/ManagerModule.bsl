...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ОшибкиПрисутствующиеВВерсии");
	НастройкиВарианта.Описание = 
		НСтр("ru = 'Содержит информацию об ошибках, присутствующих в версии проекта.'");
