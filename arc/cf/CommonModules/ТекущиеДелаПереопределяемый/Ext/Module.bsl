...
Процедура ПриОпределенииОбработчиковТекущихДел(Обработчики) Экспорт
	...
	Обработчики.Добавить(Справочники.ЗадачиПроцесса);
	Обработчики.Добавить(РегистрыСведений.ВыполнениеОбщихЗадач);
	Обработчики.Добавить(Справочники.Ошибки);
	Обработчики.Добавить(Справочники.ТехническиеПроекты);
	Обработчики.Добавить(РегистрыСведений.ИзучаемыеСтандарты);
	Обработчики.Добавить(Справочники.Патчи);
