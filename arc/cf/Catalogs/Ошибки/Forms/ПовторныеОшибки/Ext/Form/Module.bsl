...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПовторяемаяОшибка = Параметры.ПовторяемаяОшибка;
	Список.Параметры.УстановитьЗначениеПараметра("ПовторяемаяОшибка", Параметры.ПовторяемаяОшибка);
...
Процедура Зарегистрировать(Команда)
	...
	ОткрытьФорму("Справочник.Ошибки.ФормаОбъекта", Новый Структура("Основание", ПовторяемаяОшибка));
