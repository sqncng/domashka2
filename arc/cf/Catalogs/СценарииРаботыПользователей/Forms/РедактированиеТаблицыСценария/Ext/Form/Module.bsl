...
Процедура ЗагрузитьТаблицуСервер(МассивСтрокДляРедактирования = Неопределено)
	...
	Если МассивСтрокДляРедактирования = Неопределено Тогда
		МассивСтрокДляРедактирования = Параметры.СтрокиДляИзменения;
	КонецЕсли;	 
...
Процедура ОК(Команда)
	...
	Оповестить("РедактированиеТаблицыРедактора", Данные);
	Закрыть();
КонецПроцедуры
...
Процедура ПоменятьКолонкиМестами(НомерКолонки, НовыйНомерКолонки)
	...
	ПометкаНомерКолонки = СписокКолонок[НомерКолонки].Пометка;
	
	ПредставлениеНовыйНомерКолонки = СписокКолонок[НовыйНомерКолонки].Представление;
	ПометкаНовыйНомерКолонки = СписокКолонок[НовыйНомерКолонки].Пометка;
	...
	СписокКолонок[НомерКолонки].Пометка = ПометкаНовыйНомерКолонки; 
	СписокКолонок[НовыйНомерКолонки].Представление = ПредставлениеНомерКолонки; 
	СписокКолонок[НовыйНомерКолонки].Пометка = ПометкаНомерКолонки; 
	...
	Элементы["ТаблицаНаФорме_" + СписокКолонок[НомерКолонки].Значение].Видимость = ПометкаНовыйНомерКолонки;
	Элементы["ТаблицаНаФорме_" + СписокКолонок[НовыйНомерКолонки].Значение].Заголовок = ПредставлениеНомерКолонки;
	Элементы["ТаблицаНаФорме_" + СписокКолонок[НовыйНомерКолонки].Значение].Видимость = ПометкаНомерКолонки;
...
Процедура ДобавитьКолонкуСлужебный()
	...
	Текст = НСтр("ru='Введите имя новой колонки'");
